...
namespace BlazorMangas.Services.Api
{
    public class MangaService : IMangaService
    {
            ...
            ILogger<CategoriaService> logger)
        {
            ...
            _logger = logger;
            _options = new JsonSerializerOptions { PropertyNameCaseInsensitive = true }; //PropertyNameCaseInsensitive = serialização personalizada, o nome das propriedaes é case insensitive
        }
